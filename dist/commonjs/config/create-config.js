...
var createConfig = function createConfig(userConfig) {
  ...
  */
  ...
  var allLanguages = combinedConfig.allLanguages,
      ...
      defaultNS = combinedConfig.defaultNS,
    ...
    if (!hasCustomBackend) {
      ...
      */
      ...
      if (typeof defaultNS === 'string') {
        var defaultStructure = localeStructure.replace(/{{ns}}/g, defaultNS).replace(/{{lng}}/g, defaultLanguage);
        var defaultFile = "/".concat(defaultStructure, ".").concat(localeExtension);
